  ...
  return (
    <div className='fixed absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center '>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500' >
            ...
            {state !== 'Login' && 
            <div className='border-gray-200 border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                <img width={30}  className='rounded-full  ' src={assets.profile_icon}  />
                <input 
            ...
            <div className='border-gray-200 border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img className='rounded-full  ' src={assets.email_icon}  />
                <input 
                onChange={e=>setEmail(e.target.value)} value={email}
                className='outline-none text-sm ' type="text" placeholder="Email id" required />
            </div>

            <div className='border-gray-200 border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img   className='rounded-full  ' src={assets.lock_icon}  />
                <input 
