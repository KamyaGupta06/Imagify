  ...
  return (
    ...
    className='flex flex-col justify-center items-center text-center my-20'>
      ...
      className='text-center max-w-xl mx-auto mt-5'>Unleash your creativity with AI. 
        Turn your imagination into visual art in seconds - just type, 
        ...
        className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'>
         ...
         <motion.p initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1.2,duration:0.8}} className='mt-2 text-neutral-600'>Generate images from imagify</motion.p>
    </motion.div>
  )
}
